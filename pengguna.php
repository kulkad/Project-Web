                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                echo "<td><img src='img/" . $data['foto'] . "' style = 'height: 160px; '></td>"
                            ?>
                                <td> <a href='pengguna.php?aksi=edit&id_pengguna=<?= $id_pengguna ?>'>Edit</a>
                                    <a href='pengguna.php?aksi=hapus&id_pengguna=<?= $id_pengguna ?>'>Hapus</a>
                                </td>
                                </tr>
                            <?php } ?>
                        </tbody>

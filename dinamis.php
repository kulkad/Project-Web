...
<body>
  ...
  <header class="p-3 mb-5 border-bottom">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/" class="d-flex align-items-center mb-2 me-5 mb-lg-0 link-body-emphasis text-decoration-none">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="dinamis.php" class="nav-link px-2 link-secondary">Home</a></li>
          <li><a href="#about" class="nav-link px-2 link-body-emphasis">About</a></li>
          <li><a href="#produk" class="nav-link px-2 link-body-emphasis">Product</a></li>
          <li><a href="#" class="nav-link px-2 link-body-emphasis">Contact</a></li>
        </ul>

        <div class="dropdown text-end">
          <i class="fas fa-circle-user d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"></i>
          <ul class="dropdown-menu text-small">
            <li><a class="dropdown-item" href="login.php">Login</a></li>
            <li><a class="dropdown-item" href="daftar.php">Register</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="container text-center" id="about">
    <div class="row mb-5">
      ...
      <div class="col">
        <h1 class="fw-light">Animoon Store</h1>
        <br>
    ...
    <hr><br><br>
    <div class="row row-cols-1 row-cols-sm-3 g-3" id="produk">
      <?php
      include "koneksi.php";
        ...
        <div class="col">
          <div class="card" style="width: 20rem;">
            ...
            <div class="card-body">
              ...
              <a href="login.php?id=<?= $data['kode_laptop'] ?>" class="btn btn-primary">Buy Now!</a>
            </div>
          </div>
        </div>
      <?php } ?>
  ...
  <div class="container-fluid">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="pr-3 mb-5">Contact Us</span></h2>
